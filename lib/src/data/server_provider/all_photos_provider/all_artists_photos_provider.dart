...
class _AllArtistsPhotoProvider {
  Future<Operation> fetch(
    ...
    if (response.statusCode == 200) {
      ...
      var allArtists = AlbumPhotos.fromJson(responseJson);
...
final allArtistsPhotosProvider = _AllArtistsPhotoProvider();
