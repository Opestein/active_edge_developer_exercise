...
class _CreateTweetProvider {
  Future<Operation> fetch(SharedPreferences preferences, http.Client client,
    ...
    final response = await client
        .post(url, body: json.encode(createTweetRequest.toJson()), headers: {
...
final createTweetProvider = _CreateTweetProvider();
